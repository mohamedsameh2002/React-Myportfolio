        ...
        <div className='h-screen animate-lanidingAnim bg-landingImage bg-cover w-full  flexCenter '>
            <div className='flex flex-col md:flex-row -mb-20 md:gap-x-16 max-md:gap-y-4 '>
                <motion.div
                    ...
                    <h2 className='font-bold text-2xl  mb-2 text-gray-600 max-sm:text-xl '>Full Stack Develbore</h2>
                    <div className='flex gap-2'>
                        <button className=' group'>
                            <div className=' relative border border-black overflow-hidden rounded-full
                                ...
                                <a href="./background-landing.jpg" download="x.jpg" className=' px-3 py-2 z-10 transition-all duration-500 font-bold text-2xl text-slate-600 group-hover:text-white max-sm:text-xl '>Download Cv</a>
